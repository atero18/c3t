...
grid_enhancer_pb(pb7x7, resPerso[[5]]$partition, grilleAmeliorant, enregistrerTemps = TRUE)


profil1 <- profvis::profvis({res7x7 = enhancer_pb(pb7x7, resPerso[[5]]$partition)})
profil1
...
profil2 <- profvis::profvis({res20x20 = enhancer_pb(pb20x20, resPerso[[5]]$partition)})
profil2
